...
export default function UserPortal({ user, proposals, showToast, fetchProposals, portalTab, setPortalTab }) {
  ...
  const [newProposal, setNewProposal]       = useState({
    kegiatan: '', instansi: '', tgl_pelaksanaan: '', dana_diajukan: '', catatan: '', file: null
  });
  ...
  const handleCreateProposal = async () => {
    try {
      ...
      formData.append('instansi',        newProposal.instansi);
      ...
      setNewProposal({ kegiatan: '', instansi: '', email_organisasi: '', no_wa: '', tgl_pelaksanaan: '', dana_diajukan: '', file: null });
      fetchProposals();
      setPortalTab('home');
    } catch (e) {
        ...
        <div className="up-card-list">
          {filteredProposals.map(p => (
            ...
            >
              ...
              <div className="up-card-kegiatan">
                <span style={{ fontSize: '11px', color: 'var(--t3)', display: 'block', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Judul Kegiatan</span>
                {p.kegiatan}
              </div>
    ...
    <div className="up-form-wrapper">
      <div className="up-form-card">
        ...
        <div className="up-form-body">
          ...
          {/* Nama Instansi */}
          <div className="up-form-group">
            <label className="up-form-label">Nama Instansi <span>*</span></label>
            <input
              className="up-form-input"
              value={newProposal.instansi}
              onChange={e => setNewProposal({ ...newProposal, instansi: e.target.value })}
              required
            />
          </div>
        ...
        <div className="up-form-footer">
          ...
          <button
            className="up-btn-submit"
            disabled={!newProposal.kegiatan || !newProposal.instansi || !newProposal.email_organisasi || !newProposal.no_wa || !newProposal.tgl_pelaksanaan || !newProposal.dana_diajukan || !newProposal.file}
      ...
      <div className="up-detail-wrapper">
        ...
        <div className="up-detail-card">
          ...
          <div className="up-detail-header">
            ...
            <div className="up-detail-sub">{p.user?.name}</div>
          ...
          <div className="up-info-grid">
            ...
            {p.user?.instansi || p.instansi ? (
              <div className="up-info-item">
                ...
                <div className="up-info-val">{p.instansi || p.user?.instansi}</div>
              </div>
            ) : null}
